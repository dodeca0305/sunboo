-- ============================================================
-- SUNBOO経営ナビ — リセット＆初期データ投入（一括実行用）
-- ============================================================
-- このファイルを Supabase SQL Editor にコピー＆ペーストして Run してください。
-- 既存データを全削除してから再投入します（空テーブルに対して安全）。
-- ============================================================

-- 既存データをリセット（FK順に削除）
TRUNCATE TABLE official_links    RESTART IDENTITY CASCADE;
TRUNCATE TABLE procedure_documents RESTART IDENTITY CASCADE;
TRUNCATE TABLE procedures        RESTART IDENTITY CASCADE;
TRUNCATE TABLE jurisdiction_offices RESTART IDENTITY CASCADE;
TRUNCATE TABLE municipalities    RESTART IDENTITY CASCADE;
TRUNCATE TABLE prefectures       RESTART IDENTITY CASCADE;

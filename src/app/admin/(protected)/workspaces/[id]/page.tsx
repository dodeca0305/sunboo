...
// ── Company Workspace Shell（Sprint23 Phase23.1・Phase23.2）───────────
// 会社別Workspaceの「入口」と「骨組み」。会社プロフィールのみSprint23.2で実装済みのため
// リンクを張る。TaxReturn編集・Roadmap接続・ShareLink発行UIはいずれも次Sprint以降
...
const SECTIONS = [
  ...
  { icon: CalendarRange, title: '年間ロードマップ', description: '今後の手続き予定の一覧', hrefSuffix: null, comingSoon: false },
